...
<div class="emma-meta"><span>About</span><span>Design Rule</span><span>A Key Distinction</span></div>

<p class="emma-hl"><b>The distinction in one line:</b> change the <i>problem</i> and you have a new <b>game</b>; raise the <i>standard</i> on the same problem and you have a new <b>level</b>.</p>
...
<div class="emma-matchup">
  <div class="emma-fighter emma-fighter--def emma-has-pop" tabindex="0">
    ...
    <div class="emma-fighter__role">New Level</div>
    <p class="emma-fighter__obj">Same core problem, higher standard.</p>
    <span class="emma-pop">Environment unchanged · decision state unchanged · difficulty increased · same problem, stricter criteria.</span>
  </div>
  <div class="emma-matchup__vs">VS</div>
  <div class="emma-fighter emma-fighter--atk emma-has-pop" tabindex="0">
    <div class="emma-fighter__icon">🎮</div>
    <div class="emma-fighter__role">New Game</div>
    <p class="emma-fighter__obj">A different problem to solve.</p>
    <span class="emma-pop">Environment changes (e.g., wall → ground) · dominant constraint changes · win condition fundamentally different · roles change significantly.</span>
  </div>
</div>

<p class="emma-glabel">Rule of Thumb</p>
...
<div class="emma-matchup">
  <div class="emma-fighter emma-fighter--atk emma-has-pop" tabindex="0">
    <div class="emma-fighter__icon">🔒</div>
    <div class="emma-fighter__role">Wall Control</div>
    <p class="emma-fighter__obj">Attacker · establish the pin · hold 5 seconds.</p>
    <span class="emma-pop">Stage: stabilize. The problem is building and keeping the pin.</span>
  </div>
  <div class="emma-matchup__vs">VS</div>
  <div class="emma-fighter emma-fighter--def emma-has-pop" tabindex="0">
...
<div class="emma-cards">
  <div class="emma-card emma-has-pop" tabindex="0"><div class="emma-card__i">🧱</div><div class="emma-card__t">For curriculum design</div><p>Games are distinct learning units; levels are progressive mastery of one unit.<span class="emma-pop">Mixing them creates confusion about what's actually being learned.</span></p></div>
  <div class="emma-card emma-has-pop" tabindex="0"><div class="emma-card__i">📊</div><div class="emma-card__t">For assessment</div><p>Level progression shows mastery; a new game shows breadth.<span class="emma-pop">The clear distinction is what makes athlete tracking possible.</span></p></div>
  <div class="emma-card emma-has-pop" tabindex="0"><div class="emma-card__i">🗣️</div><div class="emma-card__t">For coach communication</div><p>"Run Wall Control Level 2" is unambiguous. "Run some wall stuff" is not.<span class="emma-pop">Clear naming enables precise session planning.</span></p></div>
</div>
