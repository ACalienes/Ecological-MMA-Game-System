...
??? note "Task focus &amp; coaching cues"
    ...
    <div class="emma-cards">
      <div class="emma-card"><div class="emma-card__i">🤼</div><div class="emma-card__t">Attacker</div><p>Compromise base before descent; control hips and shoulders to the ground; keep head position to avoid the DNS.</p></div>
      <div class="emma-card"><div class="emma-card__i">🐍</div><div class="emma-card__t">Defender</div><p>Keep an active base; scramble, disengage, or reverse; hunt the DNS the moment the attacker's posture breaks.</p></div>
    </div>
...
??? abstract "Constraints-Led analysis"
    ...
    <div class="emma-flow">
      <div class="emma-flow__row"><span class="emma-flow__from">Start from clinch (hands connected)</span><span class="emma-flow__arr">→</span><span class="emma-flow__to">Isolates the takedown from the entry</span></div>
      <div class="emma-flow__row"><span class="emma-flow__from">Base compromised before descent</span><span class="emma-flow__arr">→</span><span class="emma-flow__to">Prevents forcing/muscling takedowns</span></div>
      <div class="emma-flow__row"><span class="emma-flow__from">DNS allowed as primary weapon</span><span class="emma-flow__arr">→</span><span class="emma-flow__to">Punishes poor head position</span></div>
      <div class="emma-flow__row"><span class="emma-flow__from">Controlled takedown required</span><span class="emma-flow__arr">→</span><span class="emma-flow__to">Develops follow-through control</span></div>
    ...
    <div class="emma-cards">
      <div class="emma-card"><div class="emma-card__i">✋</div><div class="emma-card__t">Haptic</div><p>Weight distribution, grip tension, weight shift → takedown direction and control quality; scramble direction.</p></div>
      <div class="emma-card"><div class="emma-card__i">👁️</div><div class="emma-card__t">Visual</div><p>Hip position and angle; head/neck position → takedown availability and DNS risk or opportunity.</p></div>
      <div class="emma-card"><div class="emma-card__i">🧭</div><div class="emma-card__t">Proprioceptive</div><p>Own balance, posture, and base → safe execution position and recovery options.</p></div>
    </div>
    ...
    <div class="emma-warns">
      <span class="emma-warn">Forces takedowns through strength</span>
      <span class="emma-warn">Gets guillotined frequently</span>
      <span class="emma-warn">Loses position in scrambles</span>
      <span class="emma-warn">Only one takedown works</span>
    </div>
...
??? note "Safety &amp; related games"
    ...
    <div class="emma-flow">
      ...
      <div class="emma-flow__row"><span class="emma-flow__from">Related</span><span class="emma-flow__arr">→</span><span class="emma-flow__to"><a href="../../concepts/tko-pin/">TKO Pin</a></span></div>
    </div>
