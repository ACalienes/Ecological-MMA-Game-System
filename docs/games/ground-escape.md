...
??? note "Task focus &amp; coaching cues"
    ...
    <div class="emma-cards">
      <div class="emma-card"><div class="emma-card__i">🤸</div><div class="emma-card__t">Bottom (Defender)</div><p>Create frames and space; execute bridges, shrimps, and turns; chain escape attempts; recover to guard or standing.</p></div>
      <div class="emma-card"><div class="emma-card__i">🥋</div><div class="emma-card__t">Top (Attacker)</div><p>Maintain weight distribution; anticipate and counter escapes; stay heavy without exhausting; transition to maintain control.</p></div>
    </div>
...
??? abstract "Constraints-Led analysis"
    ...
    <div class="emma-flow">
      <div class="emma-flow__row"><span class="emma-flow__from">Bottom must actively escape</span><span class="emma-flow__arr">→</span><span class="emma-flow__to">Forces exploration of escape solutions</span></div>
      <div class="emma-flow__row"><span class="emma-flow__from">Top maintains (no submissions)</span><span class="emma-flow__arr">→</span><span class="emma-flow__to">Bottom focuses on escape, not submission defense</span></div>
      <div class="emma-flow__row"><span class="emma-flow__from">Specific starting positions</span><span class="emma-flow__arr">→</span><span class="emma-flow__to">Isolates escape patterns per position</span></div>
      <div class="emma-flow__row"><span class="emma-flow__from">Win by escape OR duration</span><span class="emma-flow__arr">→</span><span class="emma-flow__to">Urgency for bottom, patience for top</span></div>
    ...
    <div class="emma-cards">
      <div class="emma-card"><div class="emma-card__i">✋</div><div class="emma-card__t">Haptic</div><p>Pressure distribution &amp; grip location → which direction to escape and which limbs are controlled.</p></div>
      <div class="emma-card"><div class="emma-card__i">🧭</div><div class="emma-card__t">Proprioceptive</div><p>Own hip position &amp; frame strength → available escape directions and when space exists.</p></div>
      <div class="emma-card"><div class="emma-card__i">👁️</div><div class="emma-card__t">Visual</div><p>Top's posture changes &amp; space between bodies → timing windows and where to insert frames or knees.</p></div>
    </div>
    ...
    <p class="emma-hl"><b>Models:</b> being controlled in side control, mount, or back and escaping before damage accumulates or a submission occurs.</p>
    ...
    <ul class="emma-checklist">
      <li>Escapes ~60%+ against resisting partners</li>
      <li>Uses multiple escape techniques</li>
      <li>Chains escapes when the first fails</li>
      <li>Stays calm under pressure</li>
    </ul>

    <p class="emma-sub">Warning signs</p>

    <div class="emma-warns">
      <span class="emma-warn">Only one escape works</span>
      <span class="emma-warn">Escapes only vs lighter partners</span>
      <span class="emma-warn">Panic / flailing when escape fails</span>
      <span class="emma-warn">Can't feel weight distribution</span>
    </div>
...
??? note "Safety &amp; related games"
    ...
    <div class="emma-chips">
      ...
      <span class="emma-chip"><span class="emma-chip__i">🔁</span> Reset if positions stall completely</span>
    </div>
